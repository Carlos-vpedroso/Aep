...
const adicionarAlunoLista = async (req, res) => {
    try {
        ...
        const alunoExistente = await ListaBatataisAlunosViewModel.findOne({
...
const removerAlunoLista = async (req, res) => {
    try {
        ...
        const alunoNaLista = await ListaBatataisAlunosViewModel.findOne({
            where: { idLista: lista.id, idAluno },
        });
        ...
        await ListaBatataisAlunosViewModel.destroy({
            where: { idLista: lista.id, idAluno },
        });
...
const verificarAlunoNaLista = async (req, res, returnData = false) => {
    try {
        ...
        const lista = await ListaBatataisViewModel.findOne({ where: { data: hoje } });
