...
const AssociadosDiretoria: NextPage<Props> = ({ quantidadesCidade, quantidadesModalidade, quantidadesSituacao }: Props) => {
        ...
        <div className="min-h-screen p-6">
            <div className="max-w-7xl mx-auto space-y-6">
                ...
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-3xl font-bold text-[#1F1F1F]">Associados A.E.P.</h1>
                        <p className="text-gray-600 mt-1">Consulte e gerencie os associados cadastrados</p>
                    </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <Select
                                    ...
                                    onValueChange={(value) => setFiltros((prev) => ({ ...prev, situacao: value }))}
                                >
                            ...
                            <div className="space-y-2">
                                ...
                                <Select
                                    ...
                                    onValueChange={(value) => setFiltros((prev) => ({ ...prev, faculdade: value }))}
                                >
                                    <SelectTrigger className="w-full">
                            ...
                            {/* Select Turno */}
                            <div className="space-y-2">
                                <Label htmlFor="turno" className="text-sm font-medium text-[#1F1F1F]">
                            ...
                            {/* Select Cidade */}
                            <div className="space-y-2">
                                <Label htmlFor="cidade" className="text-sm font-medium text-[#1F1F1F]">
