    ...
    <div className="min-h-screen mx-auto bg-[#F5F5F5] flex items-center justify-center p-4">
      <div className="max-w-4xl w-full space-y-6">
        ...
        <div className="text-center space-y-4">
          ...
          <div>
            ...
            <p className="text-gray-600 text-lg">
              Seu cadastro foi realizado com sucesso! Agora é só aguardar nossa análise.
            </p>
          </div>
                ...
                <div key={index} className="flex items-start gap-4">
                  ...
                  <div className="flex flex-col items-center">
                    <div className={`w-12 h-12 rounded-full flex items-center justify-center ${
                      etapa.status === 'concluido' ? 'bg-[#27AE60] text-white' :
                      etapa.status === 'atual' ? 'bg-[#FFB400] text-white animate-pulse' :
                    ...
                    {index !== etapasProcesso.length - 1 && (
                      <div className={`w-px h-8 mt-2 ${
                        etapa.status === 'concluido' ? 'bg-[#27AE60]' : 'bg-gray-300'
                      }`} />
                    )}
                  </div>
                  ...
                  <div className="flex-1 pb-4">
                    <h3 className={`text-lg font-semibold ${
                      etapa.status === 'concluido' ? 'text-[#27AE60]' :
                      etapa.status === 'atual' ? 'text-[#FFB400]' :
                      'text-gray-500'
                    }`}>
                      {etapa.titulo}
                    </h3>
                    ...
                    {etapa.status === 'atual' && (
                      <Badge variant="outline" className="mt-2 text-[#FFB400] border-[#FFB400]">
                        Em andamento
                      </Badge>
                    )}
                  </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium mt-2">Fique atento às notificações!</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <CardContent>
            ...
            <div className="mt-4 p-4 bg-blue-50 rounded-lg border border-blue-200">
              <p className="text-blue-800 text-sm">
                <strong>Horário de Atendimento:</strong> Segunda à Sexta, das 8h às 18h
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <div className="text-center text-gray-500 text-sm">
          <p>
            Obrigado por escolher a Associação de Estudantes! 
            Em breve você terá acesso completo ao sistema.
          </p>
        </div>
      </div>
    </div>
