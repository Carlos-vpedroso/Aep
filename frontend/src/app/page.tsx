...
export default function Home() {
  const features = [
    ...
    },
    {
      ...
      title: "Pontualidade",
      description:
        "Horários rigorosamente cumpridos para não atrasar suas aulas",
      color: "bg-[#0057D9]",
    },
    {
      icon: Users,
  ...
  return (
    <>
          ...
          <div className="space-y-6 text-white z-10">
            <div className="space-y-4">
              ...
              <p className="text-xl text-blue-100 leading-relaxed">
                Oferecemos transporte seguro e confiável para estudantes
                universitários até suas faculdades, conectando sonhos à
                educação.
              </p>
            </div>
        ...
        <div className="w-11/12 max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-[#1F1F1F] mb-4">
              Por que escolher a A.E.P?
            </h2>
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
              Oferecemos muito mais que transporte. Oferecemos segurança,
              pontualidade e a tranquilidade que você precisa para focar nos
              seus estudos.
            </p>
          </div>
            ...
            {features.map((feature, index) => (
              ...
              >
                <CardContent className="p-6 text-center">
                  <div
                    className={`w-16 h-16 ${feature.color} rounded-2xl mx-auto mb-4 flex items-center justify-center`}
                  >
      ...
      <section className="py-16 bg-white">
        <div className="w-11/12 max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-[#0057D9] mb-4">
              Como Funciona
            </h2>
            <p className="text-gray-600 text-lg">
              Apenas 3 passos simples para começar sua jornada conosco
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {steps.map((step, index) => (
              <Card
                key={index}
                className="border-none shadow-lg hover:shadow-xl transition-all duration-300 group relative overflow-hidden"
              >
                {/* Número do passo */}
                <div className="absolute top-4 right-4 w-12 h-12 bg-[#0057D9]/10 rounded-full flex items-center justify-center">
                  <span className="text-[#0057D9] font-bold text-lg">
                    {step.step}
                  </span>
                </div>
                ...
                <CardContent className="p-6">
                  <div
                    className={`w-16 h-16 bg-[#27AE60] rounded-2xl mb-4 flex items-center justify-center group-hover:scale-110 transition-transform`}
                  >
      ...
      <section className="py-16 bg-[#F5F5F5]">
        <div className="w-11/12 max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 text-lg">
              Rotas estratégicas para conectar você à sua educação
            </p>
          </div>
                ...
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      {city.routes.length} rotas disponíveis
                    </p>
                  </div>
                </div>
                          ...
                          <Card className="border-none shadow-md hover:shadow-lg transition-all duration-300">
                            <CardHeader className="pb-4">
                              <div className="flex items-center justify-between">
                                ...
                                <Badge
                                  variant="outline"
                                  className={getTurnoColor(rota.turno)}
                                >
                              ...
                              <div className="grid grid-cols-2 gap-3">
                                ...
                                <div className="text-center p-3 bg-[#0057D9]/10 rounded-lg">
                                  <div className="flex items-center justify-center gap-1 mb-1">
                                    ...
                                    <span className="text-xs text-[#0057D9]">
                                      Chegada
                                    </span>
                                  </div>
                                  <span className="font-semibold text-[#1F1F1F]">
        ...
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="break-words">
              <h2 className="text-3xl font-bold text-[#0057D9] mb-6">
                Sobre a Associação
              </h2>
              <div className="space-y-4 text-gray-600">
                <p className="text-lg leading-relaxed">
                  Somos uma associação sem fins lucrativos criada para garantir
                  transporte acessível e seguro aos estudantes universitários da
                  região. Desde 2020, já ajudamos mais de 300 alunos a chegarem
                  até suas instituições de ensino com conforto e segurança.
                </p>
                <p>
                  Nossa missão é democratizar o acesso à educação superior,
                  oferecendo uma alternativa de transporte confiável e
                  economicamente viável para estudantes que precisam se deslocar
            ...
            <Card className="border-none shadow-xl w-full max-w-full lg:max-w-md mx-auto">
              <CardContent className="p-4 sm:p-3">
                <h3 className="text-xl font-semibold text-[#1F1F1F] mb-6 text-center">
                  Entre em Contato
                </h3>
                <div className="space-y-4">
